...
# Check Swagger JSON
curl -s http://103.92.154.211:3003/api-docs/swagger-ui-init.js | grep -i "bearer"
...
Server is running at: **http://103.92.154.211:3003**
Swagger UI: **http://103.92.154.211:3003/api-docs/**
