...
export default function WorkflowsPage() {
  ...
  useEffect(() => {
    loadScheduledJobs();
  }, [orgId, scheduledPage, scheduledPageSize, filterStatus, filterDate]);
    ...
    try {
      ...
      try {
        const liveData = await (
          await fetch("/api/pbx/calls/live", {
            headers: {
              Authorization:
                "Bearer " +
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-sm text-muted-foreground">
            Automate call handling, notifications, and integrations
          </p>
        </div>
        <div className="flex items-center gap-2">
            ...
            <div className="flex items-center gap-1.5 border rounded-md px-2.5 py-1.5 text-sm">
              ...
              {isAdmin && (
                <Button
                  ...
                  disabled={limitLoading || channelLimit <= 1}
                >
          ...
          <DropdownMenu>
            ...
            <DropdownMenuContent align="end">
              <DropdownMenuItem onClick={() => handleCreateFromTemplate("hotel_checkin")}>
              ...
              <div className="space-y-4 py-2">
                <div className="space-y-1.5">
                  ...
                  <Input
                    ...
                    placeholder="Guest Check-in Automation"
                  />
                </div>
                <div className="space-y-1.5">
                  ...
                  <Input
                    ...
                    placeholder="Send welcome message and schedule reminders"
                  />
                </div>
                <div className="space-y-1.5">
              ...
              <Table>
                ...
                <TableBody>
                  {loading ? (
                    ...
                    workflowList
                      .slice((workflowPage - 1) * workflowPageSize, workflowPage * workflowPageSize)
                      .map((wf) => {
                                    ...
                                    <DropdownMenuItem
                                      onClick={() => {
                                        navigator.clipboard.writeText(
                                          `https://gateway.example.com/trigger/${wf.id}`
                                        );
                                        showToast("Trigger URL copied", "success");
                                      }}
                                    >
                                      Copy Trigger URL
                                    </DropdownMenuItem>
            ...
            {workflowList.length > 10 && (
              <div className="border-t border-border/50 bg-muted/30 px-4 py-3 sticky bottom-0 z-10 flex items-center justify-between">
                <div className="hidden flex-1 text-sm text-muted-foreground lg:flex">
                  ...
                  {Math.min(workflowPage * workflowPageSize, workflowList.length)} of{" "}
                  {workflowList.length} entries
                </div>
                <div className="flex w-full items-center gap-8 lg:w-fit">
                  <div className="hidden items-center gap-2 lg:flex">
                    ...
                    <Select
                      ...
                      onValueChange={(value) => {
                        setWorkflowPageSize(Number(value));
                        setWorkflowPage(1);
                      }}
                    >
                  ...
                  <div className="ml-auto flex items-center gap-2 lg:ml-0">
                    ...
                    <Button
                      ...
                      size="icon"
                      onClick={() => setWorkflowPage((p) => p + 1)}
                      disabled={workflowPage * workflowPageSize >= workflowList.length}
                    >
                    ...
                    <Button
                      ...
                      size="icon"
                      onClick={() =>
                        setWorkflowPage(Math.ceil(workflowList.length / workflowPageSize))
                      }
                      disabled={workflowPage * workflowPageSize >= workflowList.length}
                    >
          ...
          {workflowList.length > 0 && (
            <div className="rounded-lg border bg-muted/30 p-4">
              ...
              <code className="text-xs break-all">
                POST https://gateway.example.com/trigger/&#123;workflow_id&#125;
              </code>
            </div>
          )}
        </TabsContent>
        ...
        <TabsContent value="scheduled" className="mt-4">
          ...
          <div className="flex flex-wrap items-end gap-2 mb-3">
            ...
            <div className="ml-auto flex items-center gap-2">
              ...
              >
                <History
                  className={`h-3.5 w-3.5 mr-1.5 ${scheduledLoading ? "animate-spin" : ""}`}
                />
                Refresh
              </Button>
            </div>
          ...
          <div className="border border-border/50 rounded-xl bg-card text-card-foreground shadow-sm overflow-hidden flex flex-col mt-2">
                ...
                <TableBody>
                  {scheduledLoading ? (
                    ...
                    [...scheduled]
                      ...
                      .map((job) => {
                        const triggerData =
                          typeof job.trigger_data === "string"
                            ? JSON.parse(job.trigger_data)
                            : job.trigger_data || {};
                        ...
                        return (
                          <TableRow key={job.id}>
                            ...
                            <TableCell className="text-sm text-muted-foreground">
                              ...
                              {!triggerData.name && !triggerData.phone && (
            ...
            {scheduledTotal > 10 && (
              <div className="border-t border-border/50 bg-muted/30 px-4 py-3 sticky bottom-0 z-10 flex items-center justify-between">
                <div className="hidden flex-1 text-sm text-muted-foreground lg:flex">
                  Showing {(scheduledPage - 1) * scheduledPageSize + 1}–
                  {Math.min(scheduledPage * scheduledPageSize, scheduledTotal)} of {scheduledTotal}{" "}
                  entries
                </div>
                <div className="flex w-full items-center gap-8 lg:w-fit">
                  <div className="hidden items-center gap-2 lg:flex">
                    ...
                    <Select
                      ...
                      onValueChange={(value) => {
                        setScheduledPageSize(Number(value));
                        setScheduledPage(1);
                      }}
                    >
                      <SelectTrigger className="w-20">
                  ...
                  <div className="ml-auto flex items-center gap-2 lg:ml-0">
                    ...
                    <Button
                      ...
                      className="hidden size-8 lg:flex"
                      size="icon"
                      onClick={() => setScheduledPage(scheduledTotalPages)}
                      disabled={scheduledPage >= scheduledTotalPages || scheduledLoading}
                    >
                      <span className="sr-only">Go to last page</span>
                      <ChevronsRight className="size-4" />
