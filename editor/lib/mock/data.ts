...
const rows: Omit<CallRow, "id" | "call_id" | "channel_id" | "started_at" | "answered_at" | "ended_at">[] = [
  { from_number: "+18005552001", to_number: "+18005551001", caller_id_name: "Customer 1",  direction: "inbound",  status: "completed", trunk_id: T[0], user_id: U[0], queue_id: Q[0], duration: 420, talk_time: 410, wait_time: 10, hangup_cause: "NORMAL_CLEARING",    cost: 0.15 },
  { from_number: "+18005552002", to_number: "+18005551001", caller_id_name: "Customer 2",  direction: "inbound",  status: "completed", trunk_id: T[0], user_id: U[1], queue_id: Q[0], duration: 540, talk_time: 525, wait_time: 15, hangup_cause: "NORMAL_CLEARING",    cost: 0.21 },
  { from_number: "+18005552003", to_number: "+18005551002", caller_id_name: "Customer 3",  direction: "inbound",  status: "completed", trunk_id: T[0], user_id: U[2], queue_id: Q[1], duration: 420, talk_time: 410, wait_time: 10, hangup_cause: "NORMAL_CLEARING",    cost: 0.15 },
  { from_number: "+18005552004", to_number: "+18005551001", caller_id_name: "Customer 4",  direction: "inbound",  status: "no_answer", trunk_id: T[0], user_id: null, queue_id: Q[0], duration: 30,  talk_time: 0,   wait_time: 30, hangup_cause: "NO_ANSWER",           cost: 0    },
  ...
  { from_number: "+18005551001", to_number: "+18005552006", caller_id_name: "Alice J",     direction: "outbound", status: "completed", trunk_id: T[0], user_id: U[0], queue_id: null, duration: 300, talk_time: 290, wait_time: 10, hangup_cause: "NORMAL_CLEARING",    cost: 0.12 },
  { from_number: "+18005551001", to_number: "+18005552007", caller_id_name: "Bob S",       direction: "outbound", status: "completed", trunk_id: T[0], user_id: U[1], queue_id: null, duration: 540, talk_time: 525, wait_time: 15, hangup_cause: "NORMAL_CLEARING",    cost: 0.21 },
  ...
  { from_number: "1001",         to_number: "1004",         caller_id_name: "Alice J",     direction: "internal", status: "completed", trunk_id: null, user_id: U[0], queue_id: null, duration: 240, talk_time: 235, wait_time: 5,  hangup_cause: "NORMAL_CLEARING",    cost: 0    },
  { from_number: "1005",         to_number: "1006",         caller_id_name: "Emma D",      direction: "internal", status: "completed", trunk_id: null, user_id: U[4], queue_id: null, duration: 180, talk_time: 175, wait_time: 5,  hangup_cause: "NORMAL_CLEARING",    cost: 0    },
  { from_number: "+18005552011", to_number: "+18005551001", caller_id_name: "Customer 11", direction: "inbound",  status: "completed", trunk_id: T[0], user_id: U[0], queue_id: Q[0], duration: 540, talk_time: 525, wait_time: 15, hangup_cause: "NORMAL_CLEARING",    cost: 0.21 },
  { from_number: "+18005552012", to_number: "+18005551001", caller_id_name: "Customer 12", direction: "inbound",  status: "completed", trunk_id: T[0], user_id: U[1], queue_id: Q[0], duration: 540, talk_time: 525, wait_time: 15, hangup_cause: "NORMAL_CLEARING",    cost: 0.21 },
  { from_number: "+18005552013", to_number: "+18005551002", caller_id_name: "Customer 13", direction: "inbound",  status: "completed", trunk_id: T[0], user_id: U[2], queue_id: Q[1], duration: 480, talk_time: 465, wait_time: 15, hangup_cause: "NORMAL_CLEARING",    cost: 0.18 },
  { from_number: "+18005552014", to_number: "+18005551003", caller_id_name: "Customer 14", direction: "inbound",  status: "completed", trunk_id: T[1], user_id: U[0], queue_id: null, duration: 540, talk_time: 530, wait_time: 10, hangup_cause: "NORMAL_CLEARING",    cost: 0.21 },
  { from_number: "+18005552015", to_number: "+18005551001", caller_id_name: "Customer 15", direction: "inbound",  status: "cancelled", trunk_id: T[0], user_id: null, queue_id: Q[0], duration: 8,   talk_time: 0,   wait_time: 8,  hangup_cause: "NORMAL_CLEARING",    cost: 0    },
];
